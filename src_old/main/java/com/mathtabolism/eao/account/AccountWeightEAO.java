...
public class AccountWeightEAO extends BaseGeneratedEntityEAO<AccountWeight> {
   ...
   */
  public AccountWeight findAccountWeightByDate(Long accountId, Date date) {
  ...
  public List<AccountWeight> findCurrentAccountWeightWeek(Long accountId, DateTime startDate) {
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("account_id", accountId);
  ...
  public List<AccountWeight> findAccountWeightsInRange(Long accountId, Date startDate, Date endDate) {
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("account_id", accountId);
