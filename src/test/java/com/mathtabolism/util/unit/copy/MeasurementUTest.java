 ...
 * 
 */
package com.mathtabolism.util.unit.copy;
...
public class MeasurementUTest {
  ...
  /**
   * Test method for
   * {@link com.mathtabolism.util.unit.Measurement#subtract(com.github.mlaursen.mathtabolism.util.calculation.Subtractable)}
   * .
   */
  @Test
  ...
  /**
   * Test method for
   * {@link com.mathtabolism.util.unit.Measurement#add(com.github.mlaursen.mathtabolism.util.calculation.Addable)}.
   */
  @Test
  public void testAdd() {
    Measurement m = new Measurement(UnitMeasurement.GRAM, 127);
