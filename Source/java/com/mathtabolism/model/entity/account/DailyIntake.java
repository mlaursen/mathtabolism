...
@Entity
@Table(
    uniqueConstraints = { @UniqueConstraint(columnNames = { "account_id", "intakeDate" }) }
)
@NamedQueries({
  @NamedQuery(
...
public class DailyIntake extends AccountIdFK implements com.mathtabolism.model.DailyIntake {
