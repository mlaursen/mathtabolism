...
public enum TDEEFormula {
   ...
   * 
   * @param weightInKG
   *          double of a Person's weight in Kilograms
   * @param heightInCM
   *          double of a Person's height in Centimeters
   * @param age
   *          the Person's age in ears
   * @param gender
   *          the {@link Gender} of the Person
   * @return a {@link Calorie} with the amount of calories required for a person that has been calculated for a
   *         TDEEFormula
   */
