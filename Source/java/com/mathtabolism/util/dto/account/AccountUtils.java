...
public class AccountUtils {
  ...
  private static <AS1 extends AccountSettingDto, AS2 extends AccountSettingDto> boolean isAccountSettingEqual(AS1 setting1, AS2 setting2, boolean isStrictlyEqual) {
    ...
    String id1 = isAccountSetting(setting1) ? ((AccountSetting) setting1).getId() : ((AccountModel) setting1).getAccountSettingId();
    String id2 = isAccountSetting(setting2) ? ((AccountSetting) setting2).getId() : ((AccountModel) setting2).getAccountSettingId();
    isEqual &= StringUtils.equals(id1, id2);
